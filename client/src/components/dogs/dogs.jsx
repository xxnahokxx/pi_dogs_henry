        ...
        <>
            <div className={style.content}>
                <div className={active ? style.expandido : style.minimizado} onClick={handleClick}>
                    ...
                    <div className={style.messageRedes}>
                        ...
                        <div className={style.redes}>
                            <a href="https://www.linkedin.com/in/johan-amaya-v/" target="_blank" rel="noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className={style.linked} viewBox="0 0 16 16">
                ...
                <div className={style.templateDogs}>
                    ...
                    <Pagination dato={data} ></Pagination>
